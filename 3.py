...
print("""\033[0;32m                          
 ...
 |  _  /_   | | | |\/| |/ _ \| '_ \/ __| __/ _ \ '__| 
 | | \ \ |__| | | |  | | (_) | | | \__ \ ||  __/ |    
 |_|  \_\____/  |_|  |_|\___/|_| |_|___/\__\___|_| 
""")
print('\033[0;31m         THE TOOL BY RJ Rafi  √')
print("""\033[1;31m
   _____________________________________________
   |Youtube:https://youtube.com/@itsrafi-?si=DRUa7geIV6ffxgCS  |
   |Tele:https://t.me/tech_hacker_bd                   |
   |Tele Team:@Rafihasan0   |
...
print("""\033[1;36m \033[3m
  ...
  [8]=>  Fsociety            [16]=>  Parrot Banner
         ...
         [99]=> rest       [0]=>  about Tool
               ...
               [00]=>  BACK TO Monster TOOL
""")
print('\033[0;35m   _________________________________________________                        ')
####metasplite install
oooo = input('\033[3m     Enter Number ==> √  :    ')
if oooo == '1' :
   os.system("cd $HOME")
   ...
   print('the metasploite Installed √ H-TOOL')
#nmap install
elif oooo =='2' :
     print('install Namp in termux √ H-TOOL')
     os.system("cd $HOME")
     os.system('pkg install nmap')
     print('the Namp Installed √ H-TOOL')
     os.system('nmap')

##Sqlmap install
elif oooo =='3' :
     print('install SQlmap in termux H-TOOL')
     os.system("cd $HOME")
     os.system("pip3 install sqlmap")
     print("the sqlmap Installed  √ H-TOOL")
     os.sytem("sqlmap")
##PyPhisher install
elif oooo =='4' :
     print('install PyPhisher in termux H-TOOL')
     os.system('cd $HOME')
     os.system('apt update')
     os.system('apt upgrade')
...
##information
   ...
   _____________________________________________
   |Youtube:https://youtube.com/@itsrafi-?si=DRUa7geIV6ffxgCS |
   |Tele:https://t.me/@Rafihasan0                     |
   |Tele Team:https://t.me/tech_hacker_bd    |
   |___________________________________________|
''')
#####
elif oooo =='99' :
